...
my_text = Label(root,text="Login",font=("helvetica",15),bg='#b9f1f0')
...
#creating label
user_name = Label(my_frame,text='UserName',bg="#ffb347",bd=4)
user_name.grid(row=0,column=0)
password = Label(my_frame,text='Password',bg='#ffb347',bd=4)
password.grid(row =2 , column =0)

#creating textbox
user = Entry(my_frame,width=30,bg='#b9f1f0',bd=4)
user.grid(row=0,column = 2 ,padx=10,pady=10)
password = Entry(my_frame,width=30,bg="#b9f1f0",bd=4)
password.grid(row=2 ,column=2,padx=10,pady=10)


#creting button to open an account
create_button = Button(my_frame,text="create an account",bg='#ffb347',command=reg)
